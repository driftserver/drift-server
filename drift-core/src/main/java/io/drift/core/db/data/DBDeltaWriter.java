...
import io.drift.core.db.metadata.ColumnMetaData;
import io.drift.core.db.metadata.DBMetaData;
import io.drift.core.db.metadata.TableMetaData;
...
public class DBDeltaWriter {
	...
	private class HTMLFormat implements Format {
		...
		public void delete(PrintStream writer, TableMetaData table, Row row) {
			writer.println("\t\t\t\t\t\t<tr>");
			writer.println("\t\t\t\t\t\t<th class=\"danger\" scope=\"row\">D</th>");
		...
		public void insert(PrintStream writer, TableMetaData table, Row row) {
			writer.println("\t\t\t\t\t\t<tr>");
			writer.println("\t\t\t\t\t\t<th class=\"success\" width=20pt scope=\"row\">I</th>");
			writeRow(writer, table, row);
			writer.println("\t\t\t\t\t\t</tr>");
		}
		...
		public void update(PrintStream writer, TableMetaData table, Row row) {
			writer.println("\t\t\t\t\t\t<tr >");
			writer.println("\t\t\t\t\t\t<th class=\"warning\" width=20pt scope=\"row\">U</th>");
			writeRow(writer, table, row);
			writer.println("\t\t\t\t\t\t</tr>");
		}
